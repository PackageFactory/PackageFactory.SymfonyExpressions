...
class ArrayHelper
{
     ...
     */
    public static function concat($array1, $array2, $array_ = null): array
    {
     ...
     */
    public static function join(iterable $array, $separator = ','): string
    {
     ...
     * @return array
     */
    public static function slice(iterable $array, $begin, $end = null): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     * @return array
     */
    public static function reverse(iterable $array): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     * @return int
     */
    public static function length(iterable $array): int
    {
        if ($array instanceof \Traversable) {
     ...
     * @return int
     */
    public static function indexOf(iterable $array, $searchElement, $fromIndex = null): int
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function random(iterable $array)
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function sort(iterable $array): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     * @return array The sorted array
     */
    public static function ksort(iterable $array): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function shuffle(iterable $array, $preserveKeys = true): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function pop(iterable $array): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function push(iterable $array, $element): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function shift(iterable $array): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     * @return array The array with the inserted elements
     */
    public static function unshift(iterable $array, $element): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function splice(iterable $array, $offset, $length = 1, $replacements = null): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function flip(iterable $array): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     */
    public static function set(iterable $array, $key, $value): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
     ...
     * @return mixed
     */
    public static function reduce(iterable $array, callable $callback, $initialValue = null)
    {
     ...
     */
    public static function filter(iterable $array, callable $callback = null): array
    {
        if ($array instanceof \Traversable) {
            $array = iterator_to_array($array);
        }
