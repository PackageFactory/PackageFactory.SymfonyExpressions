...
class StringHelper
{
     ...
     */
    public static function endsWith($string, $search, $position = null)
    {
        $string = (string)$string;
     ...
     */
    public static function indexOf($string, $search, $fromIndex = null)
    {
        $string = (string)$string;
     ...
     */
    public static function lastIndexOf($string, $search, $toIndex = null)
    {
        $string = (string)$string;
     ...
     */
    public static function pregMatch($string, $pattern)
    {
     ...
     * @throws EvaluationException
     */
    public static function pregMatchAll($string, $pattern)
    {
     ...
     */
    public static function pregReplace($string, $pattern, $replace, $limit = -1)
    {
        if ($limit === null) {
            $limit = -1;
        }
     ...
     */
    public static function pregSplit($string, $pattern, $limit = null)
    {
     ...
     */
    public static function split($string, $separator = null, $limit = null)
    {
        $string = (string)$string;
     ...
     * @return boolean
     */
    public static function startsWith($string, $search, $position = null)
    {
     ...
     */
    public static function firstLetterToUpperCase($string)
    {
     ...
     */
    public static function firstLetterToLowerCase($string)
    {
     ...
     */
    public static function htmlSpecialChars($string, $preserveEntities = false)
    {
     ...
     */
    public static function crop($string, $maximumCharacters, $suffix = '')
    {
        $string = (string)$string;
     ...
     * @return string The cropped string
     */
    public static function cropAtWord($string, $maximumCharacters, $suffix = '')
    {
        $string = (string)$string;
     ...
     * @return string The cropped string
     */
    public static function cropAtSentence($string, $maximumCharacters, $suffix = '')
    {
        $string = (string)$string;
     ...
     */
    public static function wordCount($unicodeString)
    {
     ...
     */
    public static function base64decode($string, bool $strict = false)
    {
